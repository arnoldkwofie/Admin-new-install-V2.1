...
class BusinessSettingsController extends Controller
{
    ...
    public function business_setup(Request $request)
    {
        ...
        //by arnold
        DB::table('business_settings')->updateOrInsert(['key' => 'low_value'], [
            'value' => $request['low_value']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'high_value'], [
            'value' => $request['high_value']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'low_fraction_numerator'], [
            'value' => $request['low_fraction_numerator']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'low_fraction_denominator'], [
            'value' => $request['low_fraction_denominator']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'intermediate_fraction_numerator'], [
            'value' => $request['intermediate_fraction_numerator']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'intermediate_fraction_denominator'], [
            'value' => $request['intermediate_fraction_denominator']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'high_fraction_numerator'], [
            'value' => $request['high_fraction_numerator']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'high_fraction_denominator'], [
            'value' => $request['high_fraction_denominator']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'risk_allowance'], [
            'value' => $request['risk_allowance']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'payment_gateway'], [
            'value' => $request['payment_gateway']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'restaurant_deduction'], [
            'value' => $request['restaurant_deduction']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'delivery_deduction'], [
