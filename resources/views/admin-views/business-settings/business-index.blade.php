                ...
                <form action="{{route('admin.business-settings.')}}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-12">
                            ...
                            <div class="form-group">    
                                <label class="input-label" for="exampleFormControlInput1">Risk Allowance %</label>
                                <input type="text" name="risk_allowance" value="{{$risk_allowance->value??''}}" class="form-control"
                                placeholder="Risk Allowance %" required>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-12">
                            @php($payment_gateway=\App\Models\BusinessSetting::where('key','payment_gateway')->first())
                            <div class="form-group">    
                                <label class="input-label" for="exampleFormControlInput1">Payment Gateway %</label>
                                <input type="text" name="payment_gateway" value="{{$payment_gateway->value??''}}" class="form-control"
                               placeholder="Payment Gateway %" required>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-12">
                            @php($restaurant_deduction=\App\Models\BusinessSetting::where('key','restaurant_deduction')->first())
                            <div class="form-group">    
                                <label class="input-label" for="exampleFormControlInput1">Restaurant Deduction %</label>
                                <input type="text" name="restaurant_deduction" value="{{$restaurant_deduction->value??''}}" class="form-control"
                               placeholder="Restaurant Deduction %" required>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-12">
                            @php($delivery_deduction=\App\Models\BusinessSetting::where('key','delivery_deduction')->first())
                            <div class="form-group">    
                                <label class="input-label" for="exampleFormControlInput1">Delivery Deduction %</label>
                                <input type="text" name="delivery_deduction" value="{{$delivery_deduction->value??''}}" class="form-control"
                               placeholder="Delivery Deduction %" required>
                            </div>
                        </div>
                    </div>
